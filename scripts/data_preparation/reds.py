...
if __name__ == '__main__':
    # flatten_folders('/data/users/qingluhou/Neural_network/motion_deblur/Datesets/REDS/train/train_blur_jpeg')
    # flatten_folders('/data/users/qingluhou/Neural_network/motion_deblur/Datesets/REDS/train/train_sharp')
