...
def main():
    ...
    opt['input_folder'] = '/data/users/qingluhou/Neural_network/motion_deblur/Datesets/SIDD'
    opt['save_folder'] = '/data/users/qingluhou/Neural_network/motion_deblur/Datesets/SIDD/train/input_crops'
    opt['crop_size'] = 512
    opt['step'] = 384
    opt['thresh_size'] = 0
    opt['keywords'] = '_NOISY'
    ...
    opt['save_folder'] = '/data/users/qingluhou/Neural_network/motion_deblur/Datesets/SIDD/train/gt_crops'
    opt['keywords'] = '_GT'
    extract_subimages(opt)
