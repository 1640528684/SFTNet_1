...
class DFFN(nn.Module):
    def __init__(self, dim, ffn_expansion_factor=3, bias=False):
        ...
        self.conv_1 = BasicConv(dim, dim, 3, 1, bias=False, relu=True)
        self.conv_2 = BasicConv(dim, dim, 3, 1, bias=False, relu=False)

    def forward(self, x):
        x_1 = self.conv_2(self.conv_1(x))
...
class v22Local(Local_Base, NAFNet):
