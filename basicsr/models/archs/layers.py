...
class ResBlock(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.main = nn.Sequential(
            BasicConv(in_channel, out_channel, kernel_size=3, stride=1, relu=True),  #3 1
...
class MultiSpectralAttentionLayer(torch.nn.Module):
    def __init__(self, channel, dct_h, dct_w, reduction=8, freq_sel_method='top8'):  #re=16 top16
