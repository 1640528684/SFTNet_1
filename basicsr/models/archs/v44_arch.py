...
class NAFBlock(nn.Module):
    def __init__(self, c, DW_Expand=2, FFN_Expand=2, drop_out_rate=0.):
        ...
        self.conv4 = nn.Conv2d(in_channels=2*c, out_channels=ffn_channel, kernel_size=1, padding=0, stride=1, groups=1,
                               bias=True)
        self.conv5 = nn.Conv2d(in_channels=ffn_channel, out_channels=2*c, kernel_size=1, padding=0, stride=1,
                               groups=1, bias=True)
...
class v44Local(Local_Base, NAFNet):
