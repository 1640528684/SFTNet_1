...
def _generate_3d_gaussian_kernel():
    ...
    return conv3d    #.cpu() if kernel.is_cuda else kernel  #return conv3d
...
def _ssim_3d(img1, img2, max_value):
    ...
    conv3d = _generate_3d_gaussian_kernel()  #kernel = _generate_3d_gaussian_kernel().cuda()
    ...
    mu1 = _3d_gaussian_calculator(img1, conv3d)
    mu2 = _3d_gaussian_calculator(img2, conv3d)

    mu1_sq = mu1 ** 2
    mu2_sq = mu2 ** 2
    mu1_mu2 = mu1 * mu2
    sigma1_sq = _3d_gaussian_calculator(img1 ** 2, conv3d) - mu1_sq
    sigma2_sq = _3d_gaussian_calculator(img2 ** 2, conv3d) - mu2_sq
    sigma12 = _3d_gaussian_calculator(img1*img2, conv3d) - mu1_mu2
